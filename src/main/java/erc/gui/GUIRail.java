...
public class GUIRail extends GuiContainer {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(ERC_Core.MODID, "textures/gui/gui.png");
...
//        int length = 27;
		...
		NotifyConnecttionRailManager.clickedTileForGUI.getRail().SpecialGUIInit(this);
    }
    ...
    {
		super.onGuiClosed();
		NotifyConnecttionRailManager.CloseRailGUI();
	}
...
//        
        ...
        //drawString(this.fontRendererObj, ""+NotifyConnecttionRailManager.clickedTileForGUI.GetPosNum(), 43, 29, 0xffffff);
        //drawString(this.fontRendererObj, String.format("% 2.1f",NotifyConnecttionRailManager.clickedTileForGUI.BaseRail.Power), 37, 56, 0xffffff);
        //drawString(this.fontRendererObj, NotifyConnecttionRailManager.clickedTileForGUI.SpecialGUIDrawString(), 42, 172, 0xffffff);
    }
	...
	protected void actionPerformed(GuiButton button) {
		IRail rail = NotifyConnecttionRailManager.clickedTileForGUI.getRail();
