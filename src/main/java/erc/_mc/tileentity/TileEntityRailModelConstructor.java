...
//		AuthorName = "";
    ...
    public void createVertex()
    {
        ...
        if(isDirX(side)) limitFrame.SetLengths(1, LimitFrameLength, -height, height, -width, width, true);
        else if(isDirNegX(side)) limitFrame.SetLengths(-LimitFrameLength, -1, -height, height, -width, width, true);
        else if(isDirY(side)) limitFrame.SetLengths(-width, width, 1, LimitFrameLength, -height, height, true);
        else if(isDirNegY(side)) limitFrame.SetLengths(-width, width, -LimitFrameLength, -1, -height, height, true);
        else if(isDirZ(side)) limitFrame.SetLengths(-width, width, -height, height, 1, LimitFrameLength, true);
        else if(isDirNegZ(side)) limitFrame.SetLengths(-width, width, -height, height, -LimitFrameLength, -1, true);
    }
