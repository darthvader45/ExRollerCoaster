...
public class CoasterSettings{
    ...
    public static CoasterSettings Default()
    {
        ...
        settings.Seats[0].LocalPosition = new Vec3d(0, 0.4, 0);
    ...
    public void FromString(String str)
    {
        ...
        try{
            ...
            {
                setSeatOffset(s, Integer.valueOf(data[i++]), Integer.valueOf(data[i++]), Integer.valueOf(data[i++]));
                setSeatRotation(s, Integer.valueOf(data[i++]), Integer.valueOf(data[i++]), Integer.valueOf(data[i++]));
            }
