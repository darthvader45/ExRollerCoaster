...
public class ERCMovingSoundRiding extends MovingSound {
	...
	public ERCMovingSoundRiding(EntityPlayer p_i45106_1_, EntityCoasterSeat p_i45106_2_)
	{
	...
	public void update() 
	{
		...
		{
			float f = seat.seat.GetParent()==null ? 0 : ((float) seat.seat.GetParent().getSpeed());
			if (f >= 0.01D) 
			{
