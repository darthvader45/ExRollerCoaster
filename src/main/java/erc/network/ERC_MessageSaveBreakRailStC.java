...
public class ERC_MessageSaveBreakRailStC implements IMessage, IMessageHandler<ERC_MessageSaveBreakRailStC, IMessage>{
	...
	{
		NotifyConnecttionRailManager.SetPrevRailPosConnectedDestroyBlock(message.bx, message.by, message.bz);
		NotifyConnecttionRailManager.SetNextRailPosConnectedDestroyBlock(message.nx, message.ny, message.nz);
        return null;
    }
